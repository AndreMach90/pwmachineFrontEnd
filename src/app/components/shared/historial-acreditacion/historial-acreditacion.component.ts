...
export class HistorialAcreditacionComponent implements OnInit {
  ...
  transaccionesAcreditadasHistoryExcel(nombreArchivo: any, fechaIni: any, fechaFin: any) {
    this._show_spinner = true;
    this.hcred.obtenerEquiposAcreditados(nombreArchivo).subscribe({
      next: (x) => {
        this.dataExportarExcel = x;
      }, complete: () => {
        let arrApi: any = {
          "tipo": 3,
          "Machine_Sn": nombreArchivo,
          "FechaInicio": fechaIni,
          "FechaFin": fechaFin
        }
        this._show_spinner = false;
        this.obtenerTransaccionesEquipos(arrApi);
      }, error: (e) => {
        this._show_spinner = false;
      }
    })
  ...
  obtenerTransaccionesEquipos(nombreArchivo: any) {
    ...
    this._show_spinner = true;
    this.transacciones.obtenerTransaccionesTienda2(nombreArchivo).subscribe({
      next: (y: any) => {
        ...
        this.dataExportarExcel.forEach((element: any) => {
          ...
          y.filter((elementTra: any) => {
            ...
            if (element.machine_Sn == elementTra.machine_Sn) {
        ...
        this.exportarExcel(nombreArchivo.Machine_Sn);
        this._show_spinner = false;
      }, error: (e) => {
        console.error(e);
        this._show_spinner = false;
